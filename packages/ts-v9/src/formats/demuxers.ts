 ...
 * @param options.ch_layout - (default "mono")
 */
 ...
 * @param options.recursion_depth - max recursion depth (from 0 to INT_MAX) (default 10)
 */
 ...
 * @param options.max_packet_size - maximum size of emitted packet (from 184 to 1.07374e+09) (default 204800)
 */
 ...
 * @param options.reorder_queue_size - set number of packets to buffer for handling of reordered packets (from -1 to INT_MAX) (default -1)
 * @param options.buffer_size - Underlying protocol send/receive buffer size (from -1 to INT_MAX) (default -1)
 * @param options.user_agent - override User-Agent header (default "Lavf63.1.101")
...
/**
 * Sony Wave64
 * @param options.max_size - max size of single packet (from 0 to 4.1943e+06) (default 0)
 */
...
/**
 * Animated WebP
 * @param options.min_delay - minimum valid delay between frames (in milliseconds) (from 0 to 60000) (default 10)
 * @param options.max_webp_delay - maximum valid delay between frames (in milliseconds) (from 0 to 1.67772e+07) (default 16777215)
 * @param options.default_delay - default delay between frames (in milliseconds) (from 0 to 60000) (default 100)
 * @param options.ignore_loop - ignore loop setting (default true)
 * @param options.usebgcolor - use background color from ANIM chunk (default false)
 */
export function webp_anim(options?: {
  min_delay?: number | null;
  max_webp_delay?: number | null;
  default_delay?: number | null;
  ignore_loop?: boolean | null;
  usebgcolor?: boolean | null;

}): FFMpegDemuxerOption {
  return merge({
    "min_delay": options?.min_delay,
    "max_webp_delay": options?.max_webp_delay,
    "default_delay": options?.default_delay,
    "ignore_loop": options?.ignore_loop,
    "usebgcolor": options?.usebgcolor,

...
from ffmpeg_core.options.framesync import FFMpegFrameSyncOption
from ffmpeg_core.options.timeline import FFMpegTimelineOption
...
from ffmpeg_core.streams.channel_layout import CHANNEL_LAYOUT
from ffmpeg_core.codecs.schema import FFMpegEncoderOption, FFMpegDecoderOption
from ffmpeg_core.formats.schema import FFMpegMuxerOption, FFMpegDemuxerOption
...
References:
    ...
    *,
    s: Double = Default('1'),p: Int = Default('7'),r: Int = Default('15'),t: Int = Default('36'),s1: Double = Default('1'),s2: Double = Default('1'),s3: Double = Default('1'),s4: Double = Default('1'),p1: Int = Default('0'),p2: Int = Default('0'),p3: Int = Default('0'),p4: Int = Default('0'),
...
Args:
    ...
    r: Set research size. Default is 15. Must be odd number in range [0, 99].
    t: Set parallelism. Default is 36. Must be a number in the range [1, 168]. Larger values may speed up processing, at the cost of more VRAM. Lower values will slow it down, reducing VRAM usage. Only supported on GPUs with atomic float operations (RDNA3+, Ampere+).
    ...
    s3: Set denoising strength for a specific component. Default is 1, equal to s. Must be odd number in range [1, 100].
...
References:
    ...
    *,
    w: String = Default('iw'),h: String = Default('ih'),interp_algo: Int| Literal["nearest","bilinear","bicubic","lanczos"] | Default = Default('0'),format: Pix_fmt = Default('none'),passthrough: Boolean = Default('true'),param: Float = Default('999999'),force_original_aspect_ratio: Int| Literal["disable","decrease","increase"] | Default = Default('disable'),force_divisible_by: Int = Default('1'),reset_sar: Boolean = Default('false'),

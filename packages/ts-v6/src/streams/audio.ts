 ...
 * @param options.direction - Set processing direction relative to threshold. @end table Default direction is downward.
 ...
 */
  adynamicequalizer(
    ...
    direction?: FFInt | "downward" | "upward";
    auto?: FFInt | "disabled" | "off" | "on";
    precision?: FFInt | "auto" | "float" | "double";
    enable?: FFString;
extraOptions?: Record<string, unknown>;
    },
 ...
 */
  showcwt(
    ...
    size?: FFImageSize;
    rate?: FFString;
    scale?: FFInt | "linear" | "log" | "bark" | "mel" | "erbs" | "sqrt" | "cbrt" | "qdrt";

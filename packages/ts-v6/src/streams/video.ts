 ...
 * @param options.dnn_backend - Specify which DNN backend to use for model loading and execution. This option accepts the following values: @end table
 * @param options.model - Set path to model file specifying network architecture and its parameters. Note that different backends use different file formats. TensorFlow can load files for only its format.
 ...
 *
 * @param options.dnn_backend - Specify which DNN backend to use for model loading and execution. This option accepts the following values: @end table
 * @param options.model - Set path to model file specifying network architecture and its parameters. Note that different backends use different file formats. TensorFlow, OpenVINO backend can load files for only its format.
 * @param options.input - Set the input name of the dnn network.
 * @param options.output - Set the output name of the dnn network.

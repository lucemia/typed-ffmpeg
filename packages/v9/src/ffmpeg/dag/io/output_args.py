        ...
        *streams: "FilterableStream",
        ...
        Args:
            *streams: the streams to output
            ...
            fps_mode: set framerate mode for matching video streams

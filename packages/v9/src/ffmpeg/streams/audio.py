...
class AudioStream(FilterableStream):
    ...
    def aap(
        ...
        *,
        ...
        filter_node = filter_node_factory(
            FFMpegFilterDef(
                name="aap", typings_input=("audio", "audio"), typings_output=("audio",)
            ),
            self,
            _desired,
            **merge(
    ...
    def adynamicequalizer(
        ...
        *,
        ...
        mode: Int
        | Literal["listen", "cutbelow", "cutabove", "boostbelow", "boostabove"]
        | Default = Default("cutbelow"),
        dftype: Int
        ...
        auto: Int | Literal["disabled", "off", "on", "adaptive"] | Default = Default(
            "off"
        ),
        precision: Int | Literal["auto", "float", "double"] | Default = Default("auto"),
        timeline_options: FFMpegTimelineOption | None = None,
    ...
    def aformat(
        self,
        *,
        sample_fmts: Sample_fmt = Default(None),
        sample_rates: Int = Default(None),

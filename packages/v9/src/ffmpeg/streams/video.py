...
class VideoStream(FilterableStream):
    ...
    def alphamerge(
        ...
        if framesync_options is None and any(
            v is not None for v in (eof_action, shortest, repeatlast)
        ):
            framesync_options = FFMpegFrameSyncOption(
                merge(
                    {
    ...
    def blend_vulkan(
        ...
        *,
        ...
        | Default = Default("-1"),
        c0_opacity: Float = Default("1"),
        c1_opacity: Float = Default("1"),
        c2_opacity: Float = Default("1"),
        c3_opacity: Float = Default("1"),
        all_opacity: Float = Default("1"),
        extra_options: dict[str, Any] | None = None,
    ) -> VideoStream:
        """
    ...
    def colordetect(
        self,
        *,
        mode: Flags | Literal["color_range", "alpha_mode", "all"] | Default = Default(
            "color_range+alpha_mode+all"
        ),
        extra_options: dict[str, Any] | None = None,
    ) -> VideoStream:
        """
        ...
        filter_node = filter_node_factory(
            FFMpegFilterDef(
                name="colordetect", typings_input=("video",), typings_output=("video",)
            ),
            self,
            **merge(
                {
    ...
    def colorspace(
        ...
        *,
        ...
        clipgamut: Int | Literal["none", "rgb"] | Default = Default("none"),
        iall: Int
        | Literal[
            "bt470m",
            "bt470bg",
    ...
    def deinterlace_vaapi(
        ...
        *,
        mode: Int
        | Literal["default", "bob", "weave", "motion_adaptive", "motion_compensated"]
        | Default = Default("default"),
        rate: Int | Literal["frame", "field"] | Default = Default("frame"),
        auto: Int = Default("0"),
        extra_options: dict[str, Any] | None = None,
    ) -> VideoStream:
        """
    ...
    def format(
        ...
        *,
        ...
        color_spaces: String = Default(None),
        color_ranges: String = Default(None),
        alpha_modes: String = Default(None),
        extra_options: dict[str, Any] | None = None,
    ) -> VideoStream:
        """
    ...
    def fsync(
        ...
        *,
        ...
        filter_node = filter_node_factory(
            FFMpegFilterDef(
                name="fsync", typings_input=("video",), typings_output=("video",)
            ),
            self,
            **merge(
                {
    ...
    def nlmeans_vulkan(
        ...
        *,
        ...
        r: Int = Default("15"),
        t: Int = Default("8"),
        s1: Double = Default("nan"),
        s2: Double = Default("nan"),
        s3: Double = Default("nan"),
        s4: Double = Default("nan"),
        p1: Int = Default("0"),
        p2: Int = Default("0"),
        p3: Int = Default("0"),
        p4: Int = Default("0"),
    ...
    def overlay(
        ...
        *,
        ...
        alpha: Int
        | Literal["auto", "unknown", "straight", "premultiplied"]
    ...
    def pad_cuda(
        ...
        *,
        ...
        filter_node = filter_node_factory(
            FFMpegFilterDef(
                name="pad_cuda", typings_input=("video",), typings_output=("video",)
            ),
            self,
            **merge(
                {
    ...
    def pad_vaapi(
        ...
        *,
        ...
        filter_node = filter_node_factory(
            FFMpegFilterDef(
                name="pad_vaapi", typings_input=("video",), typings_output=("video",)
            ),
            self,
            **merge(
                {
    ...
    def scale(
        ...
        *,
        ...
        reset_sar: Boolean = Default("false"),
    ...
    def scale_cuda(
        ...
        *,
        ...
        use_filters: Int | Literal["auto"] | Default = Default("auto"),
    ...
    def scale_vaapi(
        ...
        *,
        ...
        mode: Int
        | Literal["default", "fast", "hq", "nl_anamorphic"]
        | Default = Default("hq"),
        out_color_matrix: String = Default(None),
        out_range: Int
        | Literal["full", "limited", "jpeg", "mpeg", "tv", "pc"]
        | Default = Default("0"),
        out_color_primaries: String = Default(None),
        out_color_transfer: String = Default(None),
        out_chroma_location: String = Default(None),
        force_original_aspect_ratio: Int
        | Literal["disable", "decrease", "increase"]
        | Default = Default("disable"),
        force_divisible_by: Int = Default("1"),
        ...
        filter_node = filter_node_factory(
            FFMpegFilterDef(
                name="scale_vaapi", typings_input=("video",), typings_output=("video",)
            ),
            self,
            **merge(
                {
    ...
    def scale_vulkan(
        ...
        *,
        w: String = Default("iw"),
        h: String = Default("ih"),
        scaler: Int | Literal["bilinear", "nearest"] | Default = Default("bilinear"),
        debayer: Int | Literal["bilinear", "bilinear_hq"] | Default = Default(
            "bilinear_hq"
        ),
        format: String = Default(None),
        out_range: Int
        ...
        filter_node = filter_node_factory(
            FFMpegFilterDef(
                name="scale_vulkan", typings_input=("video",), typings_output=("video",)
            ),
            self,
            **merge(
                {
    ...
    def scdet_vulkan(
        ...
        *,
        ...
        filter_node = filter_node_factory(
            FFMpegFilterDef(
                name="scdet_vulkan", typings_input=("video",), typings_output=("video",)
            ),
            self,
            **merge(
                {
    ...
    def setparams(
        ...
        *,
        ...
        | Default = Default("auto"),
        alpha_mode: Int
        | Literal["auto", "unspecified", "unknown", "premultiplied", "straight"]
        | Default = Default("auto"),
        extra_options: dict[str, Any] | None = None,
    ) -> VideoStream:
        """
    ...
    def setpts(
        ...
        *,
        ...
        strip_fps: Boolean = Default("false"),
        extra_options: dict[str, Any] | None = None,
    ) -> VideoStream:
        """
    ...
    def showinfo(
        ...
        *,
        ...
        udu_sei_as_ascii: Boolean = Default("false"),
        extra_options: dict[str, Any] | None = None,
    ) -> VideoStream:
        """
    ...
    def smartblur(
        ...
        *,
        ...
        alpha_radius: Float = Default("-0.9"),
        alpha_strength: Float = Default("-2"),
        alpha_threshold: Int = Default("-31"),
        timeline_options: FFMpegTimelineOption | None = None,
        enable: str | None = None,
        extra_options: dict[str, Any] | None = None,
    ) -> VideoStream:
    ...
    def ssim360(
        ...
        *,
        stats_file: String = Default(None),
        compute_chroma: Int = Default("1"),
        frame_skip_ratio: Int = Default("0"),
        ref_projection: Int
        | Literal["e", "equirect", "c3x2", "c2x3", "barrel", "barrelsplit"]
        | Default = Default("e"),
        main_projection: Int
        | Literal["e", "equirect", "c3x2", "c2x3", "barrel", "barrelsplit"]
        | Default = Default("5"),
        ref_stereo: Int | Literal["mono", "tb", "lr"] | Default = Default("mono"),
        main_stereo: Int | Literal["mono", "tb", "lr"] | Default = Default("3"),
        ref_pad: Float = Default("0"),
        main_pad: Float = Default("0"),
        use_tape: Int = Default("0"),
        heatmap_str: String = Default(None),
        default_heatmap_width: Int = Default("32"),
        default_heatmap_height: Int = Default("16"),
        framesync_options: FFMpegFrameSyncOption | None = None,
        eof_action: str | None = None,
        shortest: bool | None = None,
        repeatlast: bool | None = None,
    ...
    def tiltandshift(
        ...
        *,
        tilt: Int = Default("1"),
        start: Int | Literal["none", "frame", "black"] | Default = Default("none"),
        end: Int | Literal["none", "frame", "black"] | Default = Default("none"),
        hold: Int = Default("0"),
        pad: Int = Default("0"),
        extra_options: dict[str, Any] | None = None,
    ) -> VideoStream:
        ...
        filter_node = filter_node_factory(
            FFMpegFilterDef(
                name="tiltandshift", typings_input=("video",), typings_output=("video",)
            ),
            self,
            **merge(
                {
    ...
    def transpose_cuda(
        ...
        *,
        ...
        | Default = Default("cclock_flip"),
        passthrough: Int | Literal["none", "landscape", "portrait"] | Default = Default(
            "none"
        ),
        extra_options: dict[str, Any] | None = None,
    ) -> VideoStream:
    ...
    def v360_vulkan(
        ...
        *,
        input: Int
        | Literal["e", "equirect", "flat", "dfisheye", "sg", "fisheye"]
        | Default = Default("e"),
        output: Int
        | Literal["e", "equirect", "flat", "dfisheye", "sg", "fisheye"]
        ...
        roll: Float = Default("0"),
        rorder: String = Default("ypr"),
        h_fov: Float = Default("90"),
        v_fov: Float = Default("45"),
        ih_fov: Float = Default("90"),
        iv_fov: Float = Default("45"),
        extra_options: dict[str, Any] | None = None,
    ) -> VideoStream:
        """
        ...
        filter_node = filter_node_factory(
            FFMpegFilterDef(
                name="v360_vulkan", typings_input=("video",), typings_output=("video",)
            ),
            self,
            **merge(
                {
    ...
    def vibrance(
        ...
        *,
        ...
        rlum: Float = Default("0.212656"),
        glum: Float = Default("0.715158"),
        blum: Float = Default("0.072186"),

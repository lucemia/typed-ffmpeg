...
References:
    ...
    *,
    sizeX: Int = Default('3'),sizeY: Int = Default('3'),planes: Int = Default('15'),
...
Args:
    sizeX: Set horizontal radius size. Range is [1, 32] and default value is 3.
    sizeY: Set vertical radius size. Range is [1, 32] and default value is 3.
    planes: Set which planes to filter. Default value is 0xf, by which all planes are processed.
    extra_options: Extra options for the filter
...
References:
    [FFmpeg Documentation](https://ffmpeg.org/ffmpeg-filters.html#avgblur_vulkan)
...
Args:
    ...
    alpha: If true, check the alpha channel instead of the luma channel. Detects frames which are (almost) transparent, instead of frames which are almost black. Default value is disabled.
    extra_options: Extra options for the filter
...
References:
    [FFmpeg Documentation](https://ffmpeg.org/ffmpeg-filters.html#blackdetect)
        ...
        filter_node = filter_node_factory(
            FFMpegFilterDef(name='blackdetect_vulkan', typings_input=('video',), typings_output=('video',)),
...
References:
    ...
    *,
    c0_mode: Int| Literal["addition","addition128","grainmerge","and","average","burn","darken","difference","difference128","grainextract","divide","dodge","exclusion","extremity","freeze","glow","hardlight","hardmix","heat","lighten","linearlight","multiply","multiply128","negation","normal","or","overlay","phoenix","pinlight","reflect","screen","softlight","subtract","vividlight","xor","softdifference","geometric","harmonic","bleach","stain","interpolate","hardoverlay"] | Default = Default('normal'),c1_mode: Int| Literal["addition","addition128","grainmerge","and","average","burn","darken","difference","difference128","grainextract","divide","dodge","exclusion","extremity","freeze","glow","hardlight","hardmix","heat","lighten","linearlight","multiply","multiply128","negation","normal","or","overlay","phoenix","pinlight","reflect","screen","softlight","subtract","vividlight","xor","softdifference","geometric","harmonic","bleach","stain","interpolate","hardoverlay"] | Default = Default('normal'),c2_mode: Int| Literal["addition","addition128","grainmerge","and","average","burn","darken","difference","difference128","grainextract","divide","dodge","exclusion","extremity","freeze","glow","hardlight","hardmix","heat","lighten","linearlight","multiply","multiply128","negation","normal","or","overlay","phoenix","pinlight","reflect","screen","softlight","subtract","vividlight","xor","softdifference","geometric","harmonic","bleach","stain","interpolate","hardoverlay"] | Default = Default('normal'),c3_mode: Int| Literal["addition","addition128","grainmerge","and","average","burn","darken","difference","difference128","grainextract","divide","dodge","exclusion","extremity","freeze","glow","hardlight","hardmix","heat","lighten","linearlight","multiply","multiply128","negation","normal","or","overlay","phoenix","pinlight","reflect","screen","softlight","subtract","vividlight","xor","softdifference","geometric","harmonic","bleach","stain","interpolate","hardoverlay"] | Default = Default('normal'),all_mode: Int| Literal["addition","addition128","grainmerge","and","average","burn","darken","difference","difference128","grainextract","divide","dodge","exclusion","extremity","freeze","glow","hardlight","hardmix","heat","lighten","linearlight","multiply","multiply128","negation","normal","or","overlay","phoenix","pinlight","reflect","screen","softlight","subtract","vividlight","xor","softdifference","geometric","harmonic","bleach","stain","interpolate","hardoverlay"] | Default = Default('-1'),c0_opacity: Float = Default('1'),c1_opacity: Float = Default('1'),c2_opacity: Float = Default('1'),c3_opacity: Float = Default('1'),all_opacity: Float = Default('1'),
...
References:
    [FFmpeg Documentation](https://ffmpeg.org/ffmpeg-filters.html#blend_vulkan)
...
References:
    [FFmpeg Documentation](https://ffmpeg.org/ffmpeg-filters.html#bwdif_vulkan)
        ...
        filter_node = filter_node_factory(
            FFMpegFilterDef(name='bwdif_vulkan', typings_input=('video',), typings_output=('video',)),
...
Args:
    dist_x: Horizontal displacement multiplier. Each chroma pixel's position will be multiplied by this amount, starting from the center of the image. Default is 0.
    dist_y: Similarly, this sets the vertical displacement multiplier. Default is 0.
    extra_options: Extra options for the filter
...
References:
    [FFmpeg Documentation](https://ffmpeg.org/ffmpeg-filters.html#chromaber_vulkan)
...
Args:
    ...
    threy: Set Y threshold for averaging chrominance values. Set finer control for max allowed difference between Y components of current pixel and neighbour pixels. Default value is 200. Allowed range is from 1 to 200.
    threu: Set U threshold for averaging chrominance values. Set finer control for max allowed difference between U components of current pixel and neighbour pixels. Default value is 200. Allowed range is from 1 to 200.
    threv: Set V threshold for averaging chrominance values. Set finer control for max allowed difference between V components of current pixel and neighbour pixels. Default value is 200. Allowed range is from 1 to 200.
...
Args:
    mode: Set of properties to detect. Unavailable properties, such as alpha mode for an input image without an alpha channel, will be ignored automatically. Accepts a combination of the following flags: @end table
    extra_options: Extra options for the filter
...
References:
    ...
    *,
    all: Int| Literal["bt470m","bt470bg","bt601-6-525","bt601-6-625","bt709","smpte170m","smpte240m","bt2020"] | Default = Default('0'),space: Int| Literal["bt709","fcc","bt470bg","smpte170m","smpte240m","ycgco","gbr","bt2020nc","bt2020ncl"] | Default = Default('2'),range: Int| Literal["tv","mpeg","pc","jpeg"] | Default = Default('0'),primaries: Int| Literal["bt709","bt470m","bt470bg","smpte170m","smpte240m","smpte428","film","smpte431","smpte432","bt2020","jedec-p22","ebu3213","vgamut"] | Default = Default('2'),trc: Int| Literal["bt709","bt470m","gamma22","bt470bg","gamma28","smpte170m","smpte240m","linear","srgb","iec61966-2-1","xvycc","iec61966-2-4","bt2020-10","bt2020-12","vlog"] | Default = Default('2'),format: Int| Literal["yuv420p","yuv420p10","yuv420p12","yuv422p","yuv422p10","yuv422p12","yuv444p","yuv444p10","yuv444p12"] | Default = Default('-1'),fast: Boolean = Default('false'),dither: Int| Literal["none","fsb"] | Default = Default('none'),wpadapt: Int| Literal["bradford","vonkries","identity"] | Default = Default('bradford'),clipgamut: Int| Literal["none","rgb"] | Default = Default('none'),iall: Int| Literal["bt470m","bt470bg","bt601-6-525","bt601-6-625","bt709","smpte170m","smpte240m","bt2020"] | Default = Default('0'),ispace: Int| Literal["bt709","fcc","bt470bg","smpte170m","smpte240m","ycgco","gbr","bt2020nc","bt2020ncl"] | Default = Default('2'),irange: Int| Literal["tv","mpeg","pc","jpeg"] | Default = Default('0'),iprimaries: Int| Literal["bt709","bt470m","bt470bg","smpte170m","smpte240m","smpte428","film","smpte431","smpte432","bt2020","jedec-p22","ebu3213","vgamut"] | Default = Default('2'),itrc: Int| Literal["bt709","bt470m","gamma22","bt470bg","gamma28","smpte170m","smpte240m","linear","srgb","iec61966-2-1","xvycc","iec61966-2-4","bt2020-10","bt2020-12","vlog"] | Default = Default('2'),
...
Args:
    ...
    clipgamut: Controls how to clip out-of-gamut colors that arise as a result of colorspace conversion. The accepted values are: @end table
...
Args:
    ...
    _0rdiv: set rdiv for 1st plane (from 0 to INT_MAX) (default 1)
...
References:
    ...
    *,
    object: String = Default(None),threshold: Float = Default('0.5'),mipmaps: Int = Default('3'),xmin: Int = Default('0'),xmax: Int = Default('INT_MAX'),discard: Boolean = Default('false'),
...
Args:
    ...
    xmax: Specifies the rectangle in which to search.
...
References:
    [FFmpeg Documentation](https://ffmpeg.org/ffmpeg-filters.html#flip_vulkan)
...
References:
    ...
    *,
    pix_fmts: String = Default(None),color_spaces: String = Default(None),color_ranges: String = Default(None),alpha_modes: String = Default(None),
...
Args:
    ...
    color_ranges: A '|'-separated list of color range names, such as "color_ranges=tv|pc".
    alpha_modes: A '|'-separated list of color range names, such as "alpha_modes=straight|premultiplied".
    extra_options: Extra options for the filter
...
Args:
    ...
    sigmaV: Set vertical sigma, if negative it will be same as sigma. Default is -1.
    planes: Set which planes to filter. By default all planes are filtered.
    size: Set the kernel size along the horizontal axis. Default is 19.
    sizeV: Set the kernel size along the vertical axis. Default is 0, which sets to use the same value as size.
    extra_options: Extra options for the filter
...
References:
    [FFmpeg Documentation](https://ffmpeg.org/ffmpeg-filters.html#gblur_vulkan)
...
References:
    [FFmpeg Documentation](https://ffmpeg.org/ffmpeg-filters.html#hflip_vulkan)
...
References:
    [FFmpeg Documentation](https://ffmpeg.org/ffmpeg-filters.html#interlace)
        ...
        filter_node = filter_node_factory(
            FFMpegFilterDef(name='interlace_vulkan', typings_input=('video',), typings_output=('video',)),
...
References:
    ...
    *,
    s: Double = Default('1'),p: Int = Default('7'),r: Int = Default('15'),t: Int = Default('8'),s1: Double = Default('nan'),s2: Double = Default('nan'),s3: Double = Default('nan'),s4: Double = Default('nan'),p1: Int = Default('0'),p2: Int = Default('0'),p3: Int = Default('0'),p4: Int = Default('0'),
...
Args:
    s: Set denoising strength for all components. Default is 1.0. Must be in range [0.0, 100.0].
    p: Set patch size for all planes. Default is 7. Must be odd number in range [0, 99].
    r: Set research size. Default is 15. Must be odd number in range [0, 99].
    t: Set parallelism. Default is 8. Must be a number in the range [1, 64]. Larger values will use more VRAM but may not result in greater speed. The optimal value is hardware and input dependent.
    s1: denoising strength for component 1 (from 0 to 100) (default nan)
    s2: denoising strength for component 2 (from 0 to 100) (default nan)
    s3: Set denoising strength for a specific component. Default is 1.0, equal to s. Must be in range [0.0, 100.0]. 0.0 disables denoising in that component.
    s4: denoising strength for component 4 (from 0 to 100) (default nan)
    p1: patch size for component 1 (from 0 to 99) (default 0)
    p2: patch size for component 2 (from 0 to 99) (default 0)
    p3: Set patch size for a specific component. Default is 7, equal to p. Must be odd number in range [0, 99].
...
References:
    [FFmpeg Documentation](https://ffmpeg.org/ffmpeg-filters.html#nlmeans_vulkan)
        ...
        filter_node = filter_node_factory(
            FFMpegFilterDef(name='nlmeans_vulkan', typings_input=('video',), typings_output=('video',)),
...
Args:
    ...
    alpha_modes: A '|'-separated list of alpha modes
    extra_options: Extra options for the filter
...
References:
    ...
    *,
    x: String = Default('0'),y: String = Default('0'),eof_action: Int| Literal["repeat","endall","pass"] | Default = Default('repeat'),eval: Int| Literal["init","frame"] | Default = Default('frame'),shortest: Boolean = Default('false'),format: Int| Literal["yuv420","yuv420p10","yuv422","yuv422p10","yuv444","yuv444p10","rgb","gbrp","auto"] | Default = Default('yuv420'),repeatlast: Boolean = Default('true'),alpha: Int| Literal["auto","unknown","straight","premultiplied"] | Default = Default('auto'),
...
Args:
    ...
    alpha: Set format of alpha of the overlaid video, it can be straight or premultiplied, or auto to choose the alpha mode automatically. Default is auto.
    framesync_options: Framesync options
    timeline_options: Timeline options
    extra_options: Extra options for the filter
...
References:
    [FFmpeg Documentation](https://ffmpeg.org/ffmpeg-filters.html#overlay_vulkan)
...
References:
    [FFmpeg Documentation](https://ffmpeg.org/ffmpeg-filters.html#pad_cuda)
        ...
        filter_node = filter_node_factory(
            FFMpegFilterDef(name='pad_cuda', typings_input=('video',), typings_output=('video',)),
...
References:
    [FFmpeg Documentation](https://ffmpeg.org/ffmpeg-filters.html#premultiply_dynamic)
        ...
        filter_node = filter_node_factory(
            FFMpegFilterDef(name='premultiply_dynamic', typings_input=('video',), typings_output=('video',)),
...
Args:
    ...
    output_max: Determines whether the max value is output to the stats log. Default value is 0. Requires stats_version >= 2. If this is set and stats_version < 2, the filter will return an error.
    framesync_options: Framesync options
    timeline_options: Timeline options
    extra_options: Extra options for the filter
...
Args:
    ...
    out_primaries: Set in/output RGB primaries. This allows the autodetected value to be overridden as well as allows forcing a specific value used for the output and encoder. Possible values: @end table
    ...
    reset_sar: Enabling this option leads to the output SAR being reset to 1. Additionally, if the user requests proportional scaling either through the width or height expressions, e.g. w=-4:h=360 or w=iw/2:h=-1 or by enabling force_original_aspect_ratio, then the input DAR is taken into account and the output is scaled to produce square pixels. Default is false.
...
References:
    ...
    *,
    w: String = Default('iw'),h: String = Default('ih'),interp_algo: Int| Literal["nearest","bilinear","bicubic","lanczos"] | Default = Default('0'),format: Pix_fmt = Default('none'),passthrough: Boolean = Default('true'),use_filters: Int| Literal["auto"] | Default = Default('auto'),param: Float = Default('999999'),force_original_aspect_ratio: Int| Literal["disable","decrease","increase"] | Default = Default('disable'),force_divisible_by: Int = Default('1'),reset_sar: Boolean = Default('false'),
...
Args:
    ...
    use_filters: If set to 1, filter with a generic weight LUT instead of using fixed-function shader kernels. May be faster or slower depending on the hardware. A value of auto (the default) enables this automatically when required for correct anti-aliasing when downscaling.
    ...
    reset_sar: Works the same as the identical scale filter option.
    extra_options: Extra options for the filter
...
References:
    ...
    *,
    w: String = Default('iw'),h: String = Default('ih'),scaler: Int| Literal["bilinear","nearest"] | Default = Default('bilinear'),debayer: Int| Literal["bilinear","bilinear_hq"] | Default = Default('bilinear_hq'),format: String = Default(None),out_range: Int| Literal["full","limited","jpeg","mpeg","tv","pc"] | Default = Default('0) (from 0 to 2) (default 0'),
...
Args:
    ...
    debayer: Debayer algorithm to use (from 0 to 2) (default bilinear_hq)
    format: Output video format (software format of hardware frames)
...
References:
    [FFmpeg Documentation](None)
        ...
        filter_node = filter_node_factory(
            FFMpegFilterDef(name='scdet_vulkan', typings_input=('video',), typings_output=('video',)),
...
Args:
    ...
    alpha_mode: Set the alpha moda. Available values are: @end table
    extra_options: Extra options for the filter
...
Args:
    ...
    strip_fps: Unset framerate metadata (default false)
    extra_options: Extra options for the filter
...
References:
    ...
    *,
    mode: Int| Literal["select","delete"] | Default = Default('select'),type: Int| Literal["PANSCAN","A53_CC","STEREO3D","MATRIXENCODING","DOWNMIX_INFO","REPLAYGAIN","DISPLAYMATRIX","AFD","MOTION_VECTORS","SKIP_SAMPLES","AUDIO_SERVICE_TYPE","MASTERING_DISPLAY_METADATA","GOP_TIMECODE","SPHERICAL","CONTENT_LIGHT_LEVEL","ICC_PROFILE","S12M_TIMECOD","S12M_TIMECODE","DYNAMIC_HDR_PLUS","REGIONS_OF_INTEREST","VIDEO_ENC_PARAMS","SEI_UNREGISTERED","FILM_GRAIN_PARAMS","DETECTION_BOUNDING_BOXES","DETECTION_BBOXES","DOVI_RPU_BUFFER","DOVI_METADATA","DYNAMIC_HDR_VIVID","AMBIENT_VIEWING_ENVIRONMENT","VIDEO_HINT"] | Default = Default('-1'),
...
Args:
    mode: Set mode of operation of the filter. Can be one of the following: @end table
    type: Set side data type used with all modes. Must be set for select mode. Possible values are: @end table
    timeline_options: Timeline options
    extra_options: Extra options for the filter
...
References:
    ...
    *,
    filename: String = Default(None),original_size: Image_size = Default(None),fontsdir: String = Default(None),alpha: Boolean = Default('false'),charenc: String = Default(None),stream_index: Int = Default('-1'),force_style: String = Default(None),wrap_unicode: Boolean = Default('auto'),shaping: Int| Literal["auto","simple","complex"] | Default = Default('auto'),
...
References:
    [FFmpeg Documentation](https://ffmpeg.org/ffmpeg-filters.html#thumbnail_cuda)
...
References:
    ...
    *,
    dir: Int| Literal["cclock_flip","clock","cclock","clock_flip","reversal","hflip","vflip"] | Default = Default('cclock_flip'),passthrough: Int| Literal["none","landscape","portrait"] | Default = Default('none'),
...
Args:
    dir: Specify the transposition direction. Can assume the following values: @end table
    passthrough: Do not apply the transposition if the input geometry matches the one specified by the specified value. It accepts the following values: @end table
    extra_options: Extra options for the filter
...
References:
    [FFmpeg Documentation](https://ffmpeg.org/ffmpeg-filters.html#transpose_cuda)
        ...
        filter_node = filter_node_factory(
            FFMpegFilterDef(name='transpose_cuda', typings_input=('video',), typings_output=('video',)),
...
References:
    [FFmpeg Documentation](https://ffmpeg.org/ffmpeg-filters.html#transpose_vulkan)
...
References:
    ...
    *,
    input: Int| Literal["e","equirect","flat","dfisheye","sg","fisheye"] | Default = Default('e'),output: Int| Literal["e","equirect","flat","dfisheye","sg","fisheye"] | Default = Default('flat'),w: Int = Default('0'),h: Int = Default('0'),yaw: Float = Default('0'),pitch: Float = Default('0'),roll: Float = Default('0'),rorder: String = Default('ypr'),h_fov: Float = Default('90'),v_fov: Float = Default('45'),ih_fov: Float = Default('90'),iv_fov: Float = Default('45'),
...
Args:
    input: set input projection (from 0 to 24) (default e)
    output: set output projection (from 0 to 24) (default flat)
    w: output width (from 0 to 32767) (default 0)
    ...
    h_fov: set output horizontal FOV angle (from 1e-05 to 360) (default 90)
    v_fov: set output vertical FOV angle (from 1e-05 to 360) (default 45)
    ih_fov: set input horizontal FOV angle (from 1e-05 to 360) (default 90)
    iv_fov: set input vertical FOV angle (from 1e-05 to 360) (default 45)
    extra_options: Extra options for the filter
...
References:
    [FFmpeg Documentation](None)
        ...
        filter_node = filter_node_factory(
            FFMpegFilterDef(name='v360_vulkan', typings_input=('video',), typings_output=('video',)),
...
References:
    [FFmpeg Documentation](https://ffmpeg.org/ffmpeg-filters.html#vflip_vulkan)
...
Args:
    ...
    fitmode: Set sample aspect ratio of video output frames. Can be used to configure waveform so it is not stretched too much in one of directions. @end table Default is none.
...
References:
    ...
    *,
    transition: Int| Literal["fade","wipeleft","wiperight","wipeup","wipedown","slidedown","slideup","slideleft","slideright","circleopen","circleclose","dissolve","pixelize","wipetl","wipetr","wipebl","wipebr"] | Default = Default('fade'),duration: Duration = Default('1'),offset: Duration = Default('0'),
...
References:
    [FFmpeg Documentation](None)
        ...
        filter_node = filter_node_factory(
            FFMpegFilterDef(name='xfade_vulkan', typings_input=('video', 'video'), typings_output=('video',)),

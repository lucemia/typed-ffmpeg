...
def _3g2(
    ...
    Args:
        ...
        movie_timescale: set movie timescale (from 0 to INT_MAX) (default 0)
...
def dash(
    ...
    availability_start_time_ms: int | None = None,

    streaming: bool | None = None,

    suggested_presentation_delay: str | None = None,
    ...
    Args:
        ...
        availability_start_time_ms: set MPD availabilityStartTime as epoch milliseconds (from 0 to 9.22337e+15) (default 0)
        streaming: Enable/Disable streaming mode of output. Each frame will be moof fragment (default false)
        suggested_presentation_delay: set MPD suggestedPresentationDelay (default 0)
    ...
    return FFMpegMuxerOption(merge({
        ...
        "availability_start_time_ms": availability_start_time_ms,
...
def matroska(
    ...
    Args:
        ...
        flipped_raw_rgb: store raw RGB bitmaps in VFW mode in bottom-up mode (default false)
        write_crc32: write a CRC32 element inside every Level 1 element (default true)
        default_mode: control how a track's FlagDefault is inferred (from 0 to 2) (default passthrough)
...
def mcc(
    ...
    Args:
        ...
        mcc_version: the mcc file format version (from 1 to 2) (default 2)
        creation_program: the creation program
        creation_time: the creation time (default "now")
...
def pdv(
    ...
    Args:
        max_frames: maximum number of frames reserved in table (mandatory) (from -1 to 65535) (default -1)
...
def rtp(
    ...
    Args:
        ...
        ssrc: Stream identifier (from 0 to UINT32_MAX) (default 0)
...
def whip(
    ...
    ts_buffer_size: int | None = None,

    whip_flags: str | None = None,

    rtp_history: int | None = None,
    ...
    Args:
        ...
        ts_buffer_size: The buffer size, in bytes, of underlying protocol (from -1 to INT_MAX) (default -1)
        whip_flags: Set flags affecting WHIP connection behavior (default 0)
        rtp_history: The number of RTP history items to store (from 64 to 2048) (default 512)
    ...
    return FFMpegMuxerOption(merge({
        ...
        "ts_buffer_size": ts_buffer_size,

        "whip_flags": whip_flags,

        "rtp_history": rtp_history,

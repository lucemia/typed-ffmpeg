...
from .schema import Default, Auto
...
def amerge(
    *streams: AudioStream,
    ...
    layout_mode: Int | Literal["legacy", "reset", "normal"] | Default = Default(
        "legacy"
    ),
    extra_options: dict[str, Any] | None = None,
) -> AudioStream:
...
def buffer(
    *,
    ...
    range: Int
    | Literal["unspecified", "unknown", "limited", "tv", "mpeg", "full", "pc", "jpeg"]
    | Default = Default("unspecified"),
    alpha_mode: Int
    | Literal["unspecified", "unknown", "straight", "premultiplied"]
    | Default = Default("unspecified"),
    extra_options: dict[str, Any] | None = None,
) -> VideoStream:
    """
...
def gradients(
    *,
    ...
    type: Int
    | Literal["linear", "radial", "circular", "spiral", "square"]
...
def perlin(
    *,
    size: Image_size = Default("320x240"),
    rate: Video_rate = Default("25"),
    octaves: Int = Default("1"),
    persistence: Double = Default("1"),
    xscale: Double = Default("1"),
    yscale: Double = Default("1"),
    tscale: Double = Default("1"),
    random_mode: Int | Literal["random", "ken", "seed"] | Default = Default("random"),
...
def scale(
    *,
    ...
    in_chroma_loc: Int
    | Literal[
        "auto", "unknown", "left", "center", "topleft", "top", "bottomleft", "bottom"
    ]
    | Default = Default("auto"),
    out_chroma_loc: Int
    | Literal[

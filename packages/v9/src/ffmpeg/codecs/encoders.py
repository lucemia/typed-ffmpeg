...
def av1_nvenc(
    ...
    preset: int | None| Literal["slow", "medium", "fast", "p1", "p2", "p3", "p4", "p5", "p6", "p7"] = None,
    ...
    b_ref_mode: int | None| Literal["disabled", "each", "middle", "hierarchical"] = None,
    ...
    split_encode_mode: int | None| Literal["disabled", "auto", "forced", "2", "3", "4"] = None,

...
def av1_nvenc(
    ...
    | None
    | Literal[
        "slow", "medium", "fast", "p1", "p2", "p3", "p4", "p5", "p6", "p7"
    ] = None,
    ...
    b_ref_mode: int
    | None
    | Literal["disabled", "each", "middle", "hierarchical"] = None,
    ...
    | None
    | Literal["disabled", "auto", "forced", "2", "3", "4"] = None,
) -> FFMpegEncoderOption:
    """
    NVIDIA NVENC av1 encoder (codec av1)

    Args:
        preset: Set the encoding preset (from 0 to 9) (default p4)
        ...
        qmin: Specifies the minimum QP used for rate control (from -1 to 255) (default -1)
        qmax: Specifies the maximum QP used for rate control (from -1 to 255) (default -1)
        ...
        b_ref_mode: Use B frames as references (from -1 to 4) (default -1)
        ...
        cbr_padding: Pad the bitstream to ensure bitrate does not drop below the target in CBR mode (default false)
...
def av1_vaapi(
    ...
    Args:
        ...
        max_frame_size: Maximum frame size (in bytes) (from 0 to 2.68435e+08) (default 0)
...
def av1_vulkan(
    ...
    Args:
        ...
        quality: Set encode quality (trades off against speed, higher is slower) (from 0 to INT_MAX) (default 0)
        ...
        profile: Set profile (from -99 to 65535) (default -99)
        tier: Set tier (seq_tier) (from 0 to 1) (default main)
        level: Set level (level_idc) (from -99 to 255) (default -99)
        units: Set units to include (default hdr)
...
def ffv1_vulkan(
    ...
    Args:
        slicecrc: Protect slices with CRCs (from -1 to 2) (default -1)
        context: Context model (from 0 to 1) (default 0)
        coder: Coder type (from -2 to 2) (default range_tab)
        qtable: Quantization table (from -1 to 2) (default default)
        slices_h: Number of horizontal slices (from -1 to 1024) (default -1)
        slices_v: Number of vertical slices (from -1 to 1024) (default -1)
        force_pcm: Code all slices with no prediction (default false)
        rct_search: Run a search for RCT parameters (level 4 only) (default true)
        async_depth: Internal parallelization depth (from 1 to INT_MAX) (default 1)
        remap_mode: Remap Mode (from -1 to 2) (default auto)
...
def h264_nvenc(
    ...
    Args:
        ...
        profile: Set the encoding profile (from 0 to 5) (default high)
        ...
        qp_cb_offset: Quantization parameter offset for cb channel (from -12 to 12) (default 0)
        qp_cr_offset: Quantization parameter offset for cr channel (from -12 to 12) (default 0)
        qmin: Specifies the minimum QP used for rate control (from -1 to 51) (default -1)
        qmax: Specifies the maximum QP used for rate control (from -1 to 51) (default -1)
...
def adpcm_argo() -> FFMpegEncoderOption:
    """
...
def adpcm_ima_qt() -> FFMpegEncoderOption:
    """
    ADPCM IMA QuickTime
...
def adpcm_swf() -> FFMpegEncoderOption:
    """
...
def libopus(
    ...
    Args:
        ...
        dtx: Enable DTX (Discontinuous transmission) (default false)
        apply_phase_inv: Apply intensity stereo phase inversion (default true)
